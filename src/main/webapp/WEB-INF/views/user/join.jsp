    ...
    $(document).ready(function () {
        ...
        $("input#userid").keyup(function () {
            ...
            if(ckid.length < 6 || ckid.length > 16) {
                $("div#idresult").text("아이디는 6자이상 16자이하입니다.").removeClass('text-primary').removeClass('text-danger').addClass('text-dark');
                isId = false;
            } else {
                $.ajax({
    ...
    <div class="col-lg-8 mx-auto">
        ...
        <form id="memberform" class="text-left mb-3" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div id="divEmail" class="custom-control-inline">
                    <input type="text" class="form-control" id="emailid" name="emailid" placeholder="이메일아이디입력..." size="25"/> @
                    <select class="form-control" id="emaildomain" name="emaildomain">
                        <option value="bit.com">비트</option>
